...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("wp-content/themes/acme/wp-config-sample.php", False),
        ("wp-content/uploads/wp-config.php", True),
        ("wp-content/backups/wp-config.php.bak", True),
        ("wp-content/plugins/acme/wp-config-local.php", False),
